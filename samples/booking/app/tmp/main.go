...
func main() {
	...
	revel.DefaultValidationKeys = map[string]map[int]string{ 
		"github.com/acsellers/yield/samples/booking/app/controllers.Application.SaveUser": { 
			55: "verifyPassword",
			56: "verifyPassword",
		},
		"github.com/acsellers/yield/samples/booking/app/controllers.Hotels.SaveSettings": { 
			99: "verifyPassword",
			101: "verifyPassword",
		},
		"github.com/acsellers/yield/samples/booking/app/models.(*Hotel).Validate": { 
			19: "hotel.Name",
			21: "hotel.Address",
			26: "hotel.City",
			32: "hotel.State",
		...
		"github.com/acsellers/yield/samples/booking/app/models.(*User).Validate": { 
			28: "user.Username",
			36: "user.Name",
		},
		"github.com/acsellers/yield/samples/booking/app/models.Booking.Validate": { 
			34: "booking.User",
			35: "booking.Hotel",
		...
		"github.com/acsellers/yield/samples/booking/app/models.ValidatePassword": { 
			44: "password",
		},
	}
